    ...
    <div className="w-full bg-[#f6f9ff] border-b-1">
      ...
      <div className={`w-full md:max-w-[1225px] mx-auto`}>
        <div className=" flex flex-wrap gap-12 ">
          <div className="text-sm w-full lg:w-96 mx-5 lg:mx-none">
          ...
          <div className="text-blue-400 mx-5 lg:mx-none">
      ...
      <div className={`${isLarge ? 'footer-bg-img ' : ' '}  py-2  `}>
        <h3 className="font-bold text-blue-400 text-xl mb-3">CONTACT US</h3>
        <div className={` ${isLarge ? ' ' : 'footer-bg-img '} text-gray-500 text-md w-full flex flex-col items-center pt-5 h-48 lg:h-full space-y-5"`}>
