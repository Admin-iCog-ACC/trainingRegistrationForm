            ...
            <div className="flex flex-wrap ">
              <div className=" space-y-5">
                ...
                <h3 className="lg:text-[26px] text-lg text-[#333333] leading-tight ">
                  Supported by iCog-ACC in partnership with YMCA Ethiopia and
                  MeSY movement will be conducting a six month acceleration
                  program. This program will be targeting youth led or owned
                  startups working on adolescents and youth sexual reproductive
                  health.
                </h3>
              </div>
            </div>
